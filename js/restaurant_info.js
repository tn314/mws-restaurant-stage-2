...
window.fillRestaurantHTML = (restaurant = self.restaurant) => {
  ...
  if(imageName.startsWith('/dist/images/undefined')) {
    image.src = '/dist/images/rr-default-800.jpg';
    image.setAttribute('srcset', '/dist/images/rr-default-400.jpg 400w, /dist/images/rr-default-600.jpg 600w, /dist/images/rr-default-800.jpg 800w, /dist/images/rr-default-800.jpg 2x');
  } else {
